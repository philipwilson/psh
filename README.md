...
**Current Version**: 0.682.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,800 lines of production code in `psh/` across 254 Python files, plus ~114,500 lines of tests in `tests/` (622 Python files)
- **Test Coverage**: 16,064 tests in 612 test files
