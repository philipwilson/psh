...
**Current Version**: 0.690.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~70,400 lines of production code in `psh/` across 255 Python files, plus ~116,200 lines of tests in `tests/` (636 Python files)
- **Test Coverage**: 16,409 tests in 626 test files
