...
**Current Version**: 0.580.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,400 lines of production code in `psh/` across 240 Python files, plus ~84,700 lines of tests in `tests/` (440 Python files)
- **Test Coverage**: 10,271 tests in 432 test files
