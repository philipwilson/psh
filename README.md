...
**Current Version**: 0.581.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,400 lines of production code in `psh/` across 240 Python files, plus ~84,900 lines of tests in `tests/` (441 Python files)
- **Test Coverage**: 10,290 tests in 433 test files
