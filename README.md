...
**Current Version**: 0.676.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,600 lines of production code in `psh/` across 254 Python files, plus ~112,900 lines of tests in `tests/` (611 Python files)
- **Test Coverage**: 15,768 tests in 602 test files
