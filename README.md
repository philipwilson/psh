...
**Current Version**: 0.684.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,800 lines of production code in `psh/` across 254 Python files, plus ~115,100 lines of tests in `tests/` (629 Python files)
- **Test Coverage**: 16,193 tests in 619 test files
