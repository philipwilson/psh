...
**Current Version**: 0.575.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,000 lines of production code in `psh/` across 240 Python files, plus ~83,600 lines of tests in `tests/` (434 Python files)
- **Test Coverage**: 10,009 tests in 426 test files
