...
**Current Version**: 0.758.0 | **Tests**: 21,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
- 🧪 **Comprehensive Testing**: 21,000+ tests ensuring reliability and robustness
...
### Project Statistics
- **Lines of Code**: ~78,900 lines of production code in `psh/` across 274 Python files, plus ~148,400 lines of tests in `tests/` (783 Python files)
- **Test Coverage**: 22,632 tests in 764 test files
