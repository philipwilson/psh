...
**Current Version**: 0.596.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~59,000 lines of production code in `psh/` across 240 Python files, plus ~88,000 lines of tests in `tests/` (458 Python files)
- **Test Coverage**: 10,999 tests in 450 test files
