...
**Current Version**: 0.773.0 | **Tests**: 25,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~83,200 lines of production code in `psh/` across 275 Python files, plus ~162,000 lines of tests in `tests/` (813 Python files)
- **Test Coverage**: 25,539 tests in 809 test files
