...
**Current Version**: 0.674.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,200 lines of production code in `psh/` across 254 Python files, plus ~111,900 lines of tests in `tests/` (606 Python files)
- **Test Coverage**: 15,596 tests in 597 test files
