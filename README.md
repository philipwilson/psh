...
**Current Version**: 0.683.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,800 lines of production code in `psh/` across 254 Python files, plus ~114,900 lines of tests in `tests/` (627 Python files)
- **Test Coverage**: 16,160 tests in 617 test files
