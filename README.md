...
**Current Version**: 0.563.0 | **Tests**: 9,300+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~57,700 lines of production code in `psh/` across 239 Python files, plus ~80,500 lines of tests in `tests/` (417 Python files)
- **Test Coverage**: 9,305 tests in 409 test files
