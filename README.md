...
**Current Version**: 0.583.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,500 lines of production code in `psh/` across 240 Python files, plus ~85,000 lines of tests in `tests/` (442 Python files)
- **Test Coverage**: 10,328 tests in 434 test files
