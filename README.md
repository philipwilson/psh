...
**Current Version**: 0.576.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,200 lines of production code in `psh/` across 240 Python files, plus ~83,900 lines of tests in `tests/` (436 Python files)
- **Test Coverage**: 10,097 tests in 428 test files
