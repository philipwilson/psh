...
**Current Version**: 0.766.0 | **Tests**: 24,900+ | **Compatibility**: POSIX + bash, verified against live bash
...
- 🧪 **Comprehensive Testing**: 24,900+ tests ensuring reliability and robustness
...
### Project Statistics
- **Lines of Code**: ~82,600 lines of production code in `psh/` across 275 Python files, plus ~159,700 lines of tests in `tests/` (808 Python files)
- **Test Coverage**: 24,925 tests in 789 test files
