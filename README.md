...
**Current Version**: 0.577.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,300 lines of production code in `psh/` across 240 Python files, plus ~84,200 lines of tests in `tests/` (439 Python files)
- **Test Coverage**: 10,164 tests in 431 test files
