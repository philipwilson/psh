...
**Current Version**: 0.672.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~68,700 lines of production code in `psh/` across 254 Python files, plus ~110,800 lines of tests in `tests/` (603 Python files)
- **Test Coverage**: 15,273 tests in 594 test files
