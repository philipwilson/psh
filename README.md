...
**Current Version**: 0.754.0 | **Tests**: 21,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~74,400 lines of production code in `psh/` across 266 Python files, plus ~132,700 lines of tests in `tests/` (722 Python files)
- **Test Coverage**: 22,024 tests in 754 test files
