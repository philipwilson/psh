...
**Current Version**: 0.689.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~70,300 lines of production code in `psh/` across 255 Python files, plus ~115,800 lines of tests in `tests/` (634 Python files)
- **Test Coverage**: 16,363 tests in 624 test files
