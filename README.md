...
**Current Version**: 0.560.0 | **Tests**: 9,100+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~57,800 lines of production code in `psh/` across 240 Python files, plus ~79,700 lines of tests in `tests/` (413 Python files)
- **Test Coverage**: 9,152 tests in 405 test files
