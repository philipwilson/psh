...
**Current Version**: 0.673.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,100 lines of production code in `psh/` across 254 Python files, plus ~111,600 lines of tests in `tests/` (605 Python files)
- **Test Coverage**: 15,530 tests in 596 test files
