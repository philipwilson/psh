...
**Current Version**: 0.698.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,100 lines of production code in `psh/` across 255 Python files, plus ~115,900 lines of tests in `tests/` (641 Python files)
