...
**Current Version**: 0.578.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,300 lines of production code in `psh/` across 240 Python files, plus ~84,400 lines of tests in `tests/` (439 Python files)
- **Test Coverage**: 10,259 tests in 431 test files
