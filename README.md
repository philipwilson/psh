...
**Current Version**: 0.561.0 | **Tests**: 9,200+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,000 lines of production code in `psh/` across 240 Python files, plus ~80,100 lines of tests in `tests/` (416 Python files)
- **Test Coverage**: 9,225 tests in 408 test files
