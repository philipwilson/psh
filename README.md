...
**Current Version**: 0.777.0 | **Tests**: 25,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~84,463 lines of production code in `psh/` across 276 Python files, plus ~169,649 lines of tests in `tests/` (835 Python files)
- **Test Coverage**: 25,632 tests in 816 test files
