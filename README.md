...
**Current Version**: 0.693.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
- 🧪 **Comprehensive Testing**: 15,000+ tests ensuring reliability and robustness
...
### Project Statistics
- **Lines of Code**: ~70,600 lines of production code in `psh/` across 255 Python files, plus ~116,800 lines of tests in `tests/` (641 Python files)
- **Test Coverage**: 16,508 tests in 631 test files
