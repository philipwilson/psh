...
**Current Version**: 0.599.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~59,600 lines of production code in `psh/` across 240 Python files, plus ~88,000 lines of tests in `tests/` (461 Python files)
- **Test Coverage**: 11,089 tests in 453 test files
