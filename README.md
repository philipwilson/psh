...
**Current Version**: 0.572.0 | **Tests**: 9,800+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,000 lines of production code in `psh/` across 239 Python files, plus ~82,900 lines of tests in `tests/` (430 Python files)
- **Test Coverage**: 9,800 tests in 422 test files
