...
**Current Version**: 0.605.0 | **Tests**: 11,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~59,900 lines of production code in `psh/` across 240 Python files, plus ~89,700 lines of tests in `tests/` (466 Python files)
- **Test Coverage**: 11,348 tests in 458 test files
