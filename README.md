...
**Current Version**: 0.678.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,300 lines of production code in `psh/` across 254 Python files, plus ~113,300 lines of tests in `tests/` (613 Python files)
- **Test Coverage**: 15,856 tests in 604 test files
