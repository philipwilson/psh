...
**Current Version**: 0.571.0 | **Tests**: 9,750+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,000 lines of production code in `psh/` across 239 Python files, plus ~82,700 lines of tests in `tests/` (429 Python files)
- **Test Coverage**: 9,755 tests in 421 test files
