...
**Current Version**: 0.573.0 | **Tests**: 9,884+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,100 lines of production code in `psh/` across 239 Python files, plus ~83,200 lines of tests in `tests/` (432 Python files)
- **Test Coverage**: 9,884 tests in 424 test files
