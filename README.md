...
**Current Version**: 0.597.0 | **Tests**: 10,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~59,500 lines of production code in `psh/` across 240 Python files, plus ~88,000 lines of tests in `tests/` (459 Python files)
- **Test Coverage**: 11,037 tests in 451 test files
