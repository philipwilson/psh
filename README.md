...
**Current Version**: 0.569.0 | **Tests**: 9,600+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~57,800 lines of production code in `psh/` across 239 Python files, plus ~82,200 lines of tests in `tests/` (428 Python files)
- **Test Coverage**: 9,651 tests in 420 test files
