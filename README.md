...
**Current Version**: 0.688.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~70,200 lines of production code in `psh/` across 255 Python files, plus ~115,700 lines of tests in `tests/` (633 Python files)
- **Test Coverage**: 16,348 tests in 623 test files
