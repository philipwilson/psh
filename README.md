...
**Current Version**: 0.564.0 | **Tests**: 9,300+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~57,700 lines of production code in `psh/` across 239 Python files, plus ~80,900 lines of tests in `tests/` (421 Python files)
- **Test Coverage**: 9,360 tests in 413 test files
