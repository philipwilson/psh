...
**Current Version**: 0.574.0 | **Tests**: 9,973+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,000 lines of production code in `psh/` across 240 Python files, plus ~83,500 lines of tests in `tests/` (434 Python files)
- **Test Coverage**: 9,973 tests in 426 test files
