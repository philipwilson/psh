...
**Current Version**: 0.562.0 | **Tests**: 9,200+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~58,000 lines of production code in `psh/` across 240 Python files, plus ~80,300 lines of tests in `tests/` (417 Python files)
- **Test Coverage**: 9,289 tests in 409 test files
