...
**Current Version**: 0.675.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,500 lines of production code in `psh/` across 254 Python files, plus ~112,500 lines of tests in `tests/` (608 Python files)
- **Test Coverage**: 15,719 tests in 599 test files
