...
**Current Version**: 0.570.0 | **Tests**: 9,700+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~57,900 lines of production code in `psh/` across 239 Python files, plus ~82,500 lines of tests in `tests/` (429 Python files)
- **Test Coverage**: 9,704 tests in 421 test files
