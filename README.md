...
**Current Version**: 0.600.0 | **Tests**: 11,000+ | **POSIX Compliance**: ~98%
...
### Project Statistics
- **Lines of Code**: ~59,700 lines of production code in `psh/` across 240 Python files, plus ~88,600 lines of tests in `tests/` (462 Python files)
- **Test Coverage**: 11,125 tests in 454 test files
