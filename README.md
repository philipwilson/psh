...
**Current Version**: 0.681.0 | **Tests**: 15,000+ | **Compatibility**: POSIX + bash, verified against live bash
...
### Project Statistics
- **Lines of Code**: ~69,600 lines of production code in `psh/` across 253 Python files, plus ~114,300 lines of tests in `tests/` (619 Python files)
- **Test Coverage**: 16,031 tests in 610 test files
