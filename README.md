...
**Current Version**: 0.765.0 | **Tests**: 24,600+ | **Compatibility**: POSIX + bash, verified against live bash
...
- 🧪 **Comprehensive Testing**: 24,600+ tests ensuring reliability and robustness
...
### Project Statistics
- **Lines of Code**: ~82,200 lines of production code in `psh/` across 275 Python files, plus ~157,800 lines of tests in `tests/` (806 Python files)
- **Test Coverage**: 24,659 tests in 787 test files
