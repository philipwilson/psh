...
├── protocols/               # Narrow runtime service protocols (Q1): VariableAccess/ExpansionRuntime/IOContext/JobRuntime/LocaleAccess — a true leaf; implementations import protocols, never the reverse
