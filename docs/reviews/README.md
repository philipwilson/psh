...
| [Improvement Program 2026-09 (LAUNCHED 2026-09-06, Wave 0 in progress)](improvement_program_2026-09-06.md) | Folds reappraisal #23 and the fresh appraisal into one wave program on the bash 5.3.15 oracle: 245-row canonical inventory re-verified at v0.779.0, 51-node gate triage, Wave 0 = oracle adoption + green gate, Waves 1–6 + Checkpoint R. Evidence in `evidence/improvement_program_2026_09/`. Owns the queue; both appraisals remain source documents. |
...
|----------|---------------|
| [ground_up_reappraisal_22_correctness_textbook_2026-07-20](ground_up_reappraisal_22_correctness_textbook_2026-07-20.md) | Whole-repo audit @ v0.749.0 (correctness + textbook) — 10 HIGH / 16 MEDIUM findings; every claim tested by the integrator reproduced at v0.750.0. Drove the Boundary Remediation Campaign (closed 2026-08-09); superseded as the latest audit by reappraisal #23 and the fresh appraisal under "Current appraisal". |
| [boundary_remediation_integrator_plan_2026-07-21](boundary_remediation_integrator_plan_2026-07-21.md) | The remediation campaign's operating plan (launched 2026-07-24; **campaign CLOSED at Ceremony C, 2026-08-09** — see the close record below): authority order, amendments A1–A12 + AM-1, roles, verification standard. Evidence: [evidence/boundary_remediation_2026-07/](evidence/boundary_remediation_2026-07/LEDGER.md). |
| [boundary_remediation_campaign_sequence_2026-07-21](boundary_remediation_campaign_sequence_2026-07-21.md) | The 2026-07 campaign's wave structure, standing rules 1–10, and finding-ownership map (adopted by the integrator plan, which governs where they differ); rules 1–10 and the wave format are adopted by reference by the Improvement Program 2026-09. |
| [Checkpoint R report (2026-08-08)](evidence/boundary_remediation_2026-07/checkpoint-r/report.md) | Sequence §10 whole-tree reappraisal at v0.773.0 after Waves 0–4: two rounds (6 scoped verifiers + 3 attack scopes), **clean bill certified under attack** — 23/23 discriminators pass, zero boundary resurrections, zero blockers; Wave 5 re-scope amendment CR-R1 + fresh census; instruments in [checkpoint-r/](evidence/boundary_remediation_2026-07/checkpoint-r/README.md). |
| [ground_up_reappraisal_19_textbook_2026-07-10](ground_up_reappraisal_19_textbook_2026-07-10.md) | Whole-repo audit @ v0.687.0 — textbook-quality edition grading elegance/clarity/efficiency (not bash compatibility); 16 auditors + 16 adversarial verifiers, 362 findings, cross-package twin ledger. Its campaign shipped v0.693–v0.724. |
| [reappraisal_19_campaign_briefs_2026-07-11](reappraisal_19_campaign_briefs_2026-07-11.md) | The campaign plan for the #19 findings (shipped v0.693–v0.724): dev briefs for every HIGH/MED cluster (dead-code sweep first, then twin convergence), standing dev rules, wave sequencing, ledger template. |
| [ground_up_reappraisal_18_2026-07-04](ground_up_reappraisal_18_2026-07-04.md) | Correctness-focused ground-up audit @ v0.617.0 — was canonical for bash-compatibility standing until #22/#23; #19 covers code health. |
...
The latest in this series is #23, listed under "Current appraisal" above
(with the fresh appraisal of the same date).
...
| [ground_up_reappraisal_18_2026-07-04](ground_up_reappraisal_18_2026-07-04.md) | #18 @ v0.617 (also listed under Live) |
...
| [Ceremony C close record (2026-08-09)](evidence/boundary_remediation_2026-07/ceremony-c/close.md) | Boundary Remediation Campaign — self-contained close (v0.751.0–v0.779.0, 29 releases): register sweeps, CR-R4 benchmark retune, HIGH-10's final leg, the transferred boundary-campaign closure. Its Part D successor register was folded into the Improvement Program 2026-09 inventory. |
