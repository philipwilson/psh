...
## Historical — ground-up reappraisal series

Each is a full-repo audit at a point in time; each is superseded by the next.
The latest ([#13](ground_up_reappraisal_13_2026-06-16.md)) is listed under Live
above.
...
| [ground_up_reappraisal_2026-06-15](ground_up_reappraisal_2026-06-15.md) | textbook-grade audit (2026-06-15) |
...
(Reappraisal #4 lives in the two `reappraisal_4_tier_*` notes under Completed.)
