...
# Reuse the scanning primitives the two legacy engines already shared, so the
# AST parser cannot disagree with them on paren matching, alternative splitting,
# or where a bracket expression ends.
from .extglob import (
    _EXTGLOB_PREFIXES,
    _bracket_end,
